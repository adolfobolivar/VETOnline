...
- The Clinic User is authenticated with a valid session (see UC-011).
...
### BR-004: Requires Authentication

This use case requires a valid Clinic User session (see UC-011, BR-003).